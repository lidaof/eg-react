...
export class DynamicHeatmap extends React.PureComponent<DynamicHeatmapProps, {}> {
    // static getHeight(props: DynamicHeatmapProps) {
    ...
    renderRect = (placedInteraction: PlacedInteraction, index: number) => {
        ...
        // return <svg width={width} height={DynamicHeatmap.getHeight(this.props)} onMouseOut={onMouseOut} >{diamonds}</svg>;
    };
