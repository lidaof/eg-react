import FeatureInterval from '../FeatureInterval';
...
describe("constructor", () => {
    it("sets instance variables correctly", () => {
        const instance = new FeatureInterval(FEATURE, 0, 5);
...
describe("methods", () => {
    ...
    it("getOverlap() is correct", () => {
        expect(INSTANCE.getOverlap(new ChromosomeInterval("chr1", 13, 20)))
            .toEqual(new FeatureInterval(FEATURE, 3, 5));
    });
    ...
    it("toStringWithOther() is correct", () => {
        ...
        const instance2 = new FeatureInterval(feature2, 5, 10);
