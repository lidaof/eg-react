...
// const { arrayCopy } = require('../utils/arrayCopy');
          ...
          thisB.bwg.data.slice(fetchStart, fetchSize).fetch(function(result) {
            ...
            while (offset < fetchSize) {
              ...
              if (thisB.bwg.uncompressBufSize > 0) {
                ...
                // data = zlib.inflateSync(result, offset + 2, fb.size - 2);
                            // dpuru
              } else {
...
BigWig.prototype.getZoomedView = function(z) {
  ...
  if (!zh.view) {
    zh.view = new BigWigView(this, zh.indexOffset,
    /* this.zoomLevels[z + 1].dataOffset - zh.indexOffset */
    4000, true);
  }
  return zh.view;
}
